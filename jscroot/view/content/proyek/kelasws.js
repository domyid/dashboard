...
const tugaskelasws = backend.project.kelasws;
...
function actionfunctionname(){
    ...
    if (getCookie("login")===""){
        ...
        postJSON(tugaskelasws,"login",getCookie("login"),idprjusr,postResponseFunction);
    }
}
...
function fetchTugasScore() {
    getJSON(tugaskelasws+'/weekly', 'login', getCookie('login'), handleTugasScoreResponse);
}
